...
const (
	...
	Calendar_ListEvent_FullMethodName   = "/event.Calendar/ListEvent"
)
...
type CalendarClient interface {
	AddEvent(ctx context.Context, in *AddEventRequest, opts ...grpc.CallOption) (*StatusMessageResponce, error)
	UpdateEvent(ctx context.Context, in *UpdateEventRequest, opts ...grpc.CallOption) (*StatusMessageResponce, error)
	DeleteEvent(ctx context.Context, in *DeleteEventRequest, opts ...grpc.CallOption) (*StatusMessageResponce, error)
	ListEvent(ctx context.Context, in *ListEventRequest, opts ...grpc.CallOption) (*EventsListResponce, error)
}
...
func (c *calendarClient) AddEvent(ctx context.Context, in *AddEventRequest, opts ...grpc.CallOption) (*StatusMessageResponce, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StatusMessageResponce)
...
func (c *calendarClient) UpdateEvent(ctx context.Context, in *UpdateEventRequest, opts ...grpc.CallOption) (*StatusMessageResponce, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StatusMessageResponce)
...
func (c *calendarClient) DeleteEvent(ctx context.Context, in *DeleteEventRequest, opts ...grpc.CallOption) (*StatusMessageResponce, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StatusMessageResponce)
...
func (c *calendarClient) ListEvent(ctx context.Context, in *ListEventRequest, opts ...grpc.CallOption) (*EventsListResponce, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EventsListResponce)
...
type CalendarServer interface {
	AddEvent(context.Context, *AddEventRequest) (*StatusMessageResponce, error)
	UpdateEvent(context.Context, *UpdateEventRequest) (*StatusMessageResponce, error)
	DeleteEvent(context.Context, *DeleteEventRequest) (*StatusMessageResponce, error)
	ListEvent(context.Context, *ListEventRequest) (*EventsListResponce, error)
...
func (UnimplementedCalendarServer) AddEvent(context.Context, *AddEventRequest) (*StatusMessageResponce, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddEvent not implemented")
}
func (UnimplementedCalendarServer) UpdateEvent(context.Context, *UpdateEventRequest) (*StatusMessageResponce, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateEvent not implemented")
}
func (UnimplementedCalendarServer) DeleteEvent(context.Context, *DeleteEventRequest) (*StatusMessageResponce, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteEvent not implemented")
}
func (UnimplementedCalendarServer) ListEvent(context.Context, *ListEventRequest) (*EventsListResponce, error) {
